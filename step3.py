...
def appliquer_filtre(image_path, output_path, couleur):
    ...
    for i in range(img.size[0]):
        for j in range(img.size[1]):
            ...
            # Appliquer le filtre en ajustant les canaux avec normalisation
...
if __name__ == "__main__":
    ...
    # Appliquer le filtre de couleur argile foncé (RGB : 209, 196, 185)
    appliquer_filtre(input_image_path, output_image_path, (209, 196, 185))
